// Vendored from @plone/scripts v4.0.1 — plone/volto:packages/scripts/prepublish.js (MIT).
// Kept as a verbatim copy: depending on @plone/scripts directly would pull in babel,
// mrs-developer, execa and friends for this one file. Re-sync from upstream rather
// than editing in place, so the two stay diffable.
